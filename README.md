...
e.g. 
posix_chain_of_thought_mistralai_Mistral-7B-Instruct-v0.1_merged.csv
...
- **Output files**:  
 judged_scores_{technique}_{target_model_short}.csv
judged_scores_all.csv
summary_scores_table.csv
